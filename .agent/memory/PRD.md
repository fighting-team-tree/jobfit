...
- **서비스명:** JobFit (Career Impact Agent - CIA)
...
| **2. 갭 분석** | • '이력서 vs JD' 매칭 점수 산출<br>• 기술적 약점(Missing Skills) 도출<br>• 맹점(Blind Spot) 리포트 생성 | • LLM (GPT-4o, Claude 3.5, Gemini 1.5/3.5)<br>• RAG (Vector DB) |
| **3. 실전 훈련** | • 음성 대화형 기술 면접 (꼬리물기 질문 포함)<br>• 면접 도중 실시간 피드백<br>• **GitHub 코드 리뷰 연동 모드**: JD 적합도 기반 AI 저장소 추천, 소스 파일 분석 요약(Brief) 생성 및 음성 면접관 시스템 프롬프트(overrides) 주입 연동 | • **ElevenLabs Conv. AI SDK / WebSocket**<br>• Deepgram STT Streaming<br>• Code Review Heuristics & Summarization |
