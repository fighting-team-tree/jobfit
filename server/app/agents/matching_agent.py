...
Return ONLY the JSON, no other text."""
    ...
    def _extract_tech_keywords(self, text: str) -> List[str]:
        ...
        tech_keywords = [
            ...
            "agile", "scrum", "jira", "figma", "design patterns"
        ]
...
Return ONLY the JSON."""
        ...
        try:
            ...
            strengths = [f"Strong in {s}" for s in matching_skills[:3]] if matching_skills else ["Profile under analysis"]
            recommendations = [f"Consider learning {s}" for s in missing_skills[:3]] if missing_skills else ["Keep updating your skills"]
