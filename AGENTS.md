# JobFit Development Guide (Codex)

Codex AI 어시스턴트를 위한 개발 가이드입니다.
...
`.Codex/commands/` 디렉토리에 정의된 명령어입니다:
...
| `/company-analyze` | 회사별 매칭 분석 (Codex Agent) |
...
| `07-Codex-agent.md` | LangGraph 에이전트 규칙 |
